    ...
    <>
      <PageIntro eyebrow="Über uns" title="Wir machen eure Bar besser.">
        ...
        <div className="mt-10 max-w-2xl space-y-6 text-base">
          ...
          <h3>Unser Coach:</h3>
          <p>Unser Bar-Coach Ralf, lebt seit 2014 in Berlin und ist seit 2015 fester Bestandteil der hiesigen Gastro-Szene. Er hat von der urigen Eck-Kneipe bis zum luxuriösen 5-Sterne-Hotel Getränke zubereitet und vorallem auch getrunken, zahllose Bücher über das Barhandwerk gewälzt und bereits an einigen großen Cocktail-Wettbewerben teilgenommen. Seit 2019 ist er bei uns im Unternehmen und konnte in den letzten fünf Jahren einen sehr umfassenden Einblick in Großproduktion sowie Bar- und Servicebetrieb erlangen.</p>
        </div>
      </PageIntro>
